...
int					trash_error(t_name_comm info, char *line,
	int tr, char *f_name);
...
int					live_zjmp_fork_lfork(char *line,
...
int					if_find_close(t_name_comm *info,
	char **line, int close, char *name);
int					next_line_quatation(t_name_comm *info,
	char *f_name, char *line);
